      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <Film className="w-8 h-8 text-blue-500 group-hover:text-blue-400 transition" aria-hidden />
          ...
          <div className="hidden md:flex items-center gap-1">
            ...
            <Link
              to="/favorites"
              className="flex items-center gap-2 px-4 py-2 text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition font-medium"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden py-4 border-t border-slate-800">
            {/* Mobile Search (keeps same behavior as desktop) */}
            ...
            <div className="space-y-1 px-2">
              ...
              <Link
                to="/favorites"
                onClick={() => setIsMobileMenuOpen(false)}
                className="flex items-center gap-2 px-4 py-2.5 text-slate-300 hover:text-white hover:bg-slate-800 rounded-lg transition font-medium"
              >
                <Heart className="w-4 h-4" aria-hidden />
                Favorites
              </Link>
